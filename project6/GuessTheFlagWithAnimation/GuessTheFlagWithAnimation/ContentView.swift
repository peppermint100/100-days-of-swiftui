//
//  ContentView.swift
//  GuessTheFlagWithAnimation
//
//  Created by peppermint100 on 2023/02/13.
//
                   ...
                   ForEach (0..<3) { number in
                       Button {
                           ...
                           Image(countries[number])
                               ...
                               .clipShape(Capsule())
                               .shadow(radius: 5)
                               .rotation3DEffect(.degrees(tappedFlagIndex == number ? rotationAmount : 0), axis: (x:0 ,y:1, z:0))
                               .opacity(tappedFlagIndex == number ? 1 : opacityAmount)
                               .animation(.easeIn.repeatCount(3, autoreverses: true), value: opacityAmount)
                       }
                   }
               } // Vstack 카드
